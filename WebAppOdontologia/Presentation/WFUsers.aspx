            ...
            <form runat="server">
                ...
                <div class="row m-1">
                    <div class="col">
                        ...
                        <asp:RequiredFieldValidator ID="RFVMail" runat="server" ControlToValidate="TBMail"
                    ...
                    <div class="col-4">
                        ...
                        <asp:RequiredFieldValidator ID="RFVContrasena" runat="server" ControlToValidate="TBContrasena"
                            CssClass="text-danger" ErrorMessage="Este campo es obligatorio."></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-2">
                        <%--Estados--%>
